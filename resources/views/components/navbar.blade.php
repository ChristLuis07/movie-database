<nav class="navbar fixed-top navbar-expand-lg bg-body-nav">
  <div class="container-fluid">
    ...
    <a class="navbar-brand" href="#">
      <img class="navbar-icon" src="{{ asset('assets/img/C07Stream_transparent.png') }}" alt="">
    </a>
      ...
      <ul class="pt-3 nav-icon d-flex">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu user-info">
            <li><a class="dropdown-item user-info-item" href="#"><i class="fa-solid fa-circle-user"></i> Profile
                Setting</a></li>
            <li>
